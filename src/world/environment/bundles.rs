use crate::world::environment::components::{EnvironmentBounds, EnvironmentFeature};
use bevy::math::{Quat, Vec2};
use bevy::prelude::{
    Bundle, GlobalTransform, InheritedVisibility, Sprite, Transform, ViewVisibility, Visibility,
};
